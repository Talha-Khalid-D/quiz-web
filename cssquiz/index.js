...
const loadquiz = () =>{
    const {Question , Options} = cssquizData[currentquiz];
    // console.log(Options);
...
submitbtn.addEventListener('click', ()=>{
    ...
    if(selectedOptionIndex === cssquizData[currentquiz].Correct){
        score = score + 1;
    }
    ...
    if(currentquiz < cssquizData.length){
        ...
        quiz.innerHTML = `
        <div class="result">
        <h2> Your Score : ${score} / ${cssquizData.length} Correct Answers </h2>
