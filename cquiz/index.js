...
const loadquiz = () =>{
    const {Question , Options} = cquizData[currentquiz];
    // console.log(Options);
...
submitbtn.addEventListener('click', ()=>{
    ...
    if(selectedOptionIndex === cquizData[currentquiz].Correct){
        score = score + 1;
    }
    ...
    if(currentquiz < cquizData.length){
        deselectedAnswers();
        loadquiz();
    }else{
        quiz.innerHTML = `
        <div class="result">
        <h2> Your Score : ${score} / ${cquizData.length} Correct Answers </h2>
