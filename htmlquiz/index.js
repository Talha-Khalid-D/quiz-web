...
const loadquiz = () =>{
    const {Question , Options} = hquizData[currentquiz];
    // console.log(Options);
...
submitbtn.addEventListener('click', ()=>{
    ...
    if(selectedOptionIndex === hquizData[currentquiz].Correct){
        score = score + 1;
    }
    ...
    if(currentquiz < hquizData.length){
        deselectedAnswers();
        loadquiz();
    }else{
        quiz.innerHTML = `
        <div class="result">
        <h2> Your Score : ${score} / ${hquizData.length} Correct Answers </h2>
