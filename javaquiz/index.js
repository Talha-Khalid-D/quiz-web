...
const loadquiz = () =>{
    const {Question , Options} = jquizData[currentquiz];
    // console.log(Options);
...
submitbtn.addEventListener('click', ()=>{
    ...
    if(selectedOptionIndex === jquizData[currentquiz].Correct){
        score = score + 1;
    }
    ...
    if(currentquiz < jquizData.length){
        deselectedAnswers();
        loadquiz();
    }else{
        quiz.innerHTML = `
        <div class="result">
        <h2> Your Score : ${score} / ${jquizData.length} Correct Answers </h2>
